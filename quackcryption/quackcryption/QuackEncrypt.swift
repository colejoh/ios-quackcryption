...
func quackcrypt(plainString: String) -> String {
    ...
    let size = plainStringArray.count
    
    for i in 0...(size - 1) {
        let character = plainStringArray[i]
...
func quackReader(encryptedString: String) -> String {
    ...
    for quack in quackCryptedArray {
        ...
        case "quackquack":
            ...
            break;
        case "Quackquack":
            deQuacked += String(UnicodeScalar(1));
            break;
        case "qUackquack":
            deQuacked += String(UnicodeScalar(2));
            break;
        case "QUackquack":
            deQuacked += String(UnicodeScalar(3));
            break;
        case "quAckquack":
            deQuacked += String(UnicodeScalar(4));
            break;
        case "QuAckquack":
            deQuacked += String(UnicodeScalar(5));
            break;
        case "qUAckquack":
            deQuacked += String(UnicodeScalar(6));
            break;
        case "QUAckquack":
            deQuacked += String(UnicodeScalar(7));
            break;
        case "quaCkquack":
            deQuacked += String(UnicodeScalar(8));
            break;
        case "QuaCkquack":
            deQuacked += String(UnicodeScalar(9));
            break;
        case "qUaCkquack":
            deQuacked += String(UnicodeScalar(10));
            break;
        case "QUaCkquack":
            deQuacked += String(UnicodeScalar(11));
            break;
        case "quACkquack":
            deQuacked += String(UnicodeScalar(12));
            break;
        case "QuACkquack":
            deQuacked += String(UnicodeScalar(13));
            break;
        case "qUACkquack":
            deQuacked += String(UnicodeScalar(14));
            break;
        case "QUACkquack":
            deQuacked += String(UnicodeScalar(15));
            break;
        case "quacKquack":
            deQuacked += String(UnicodeScalar(16));
            break;
        case "QuacKquack":
            deQuacked += String(UnicodeScalar(17));
            break;
        case "qUacKquack":
            deQuacked += String(UnicodeScalar(18));
            break;
        case "QUacKquack":
            deQuacked += String(UnicodeScalar(19));
            break;
        case "quAcKquack":
            deQuacked += String(UnicodeScalar(20));
            break;
        case "QuAcKquack":
            deQuacked += String(UnicodeScalar(21));
            break;
        case "qUAcKquack":
            deQuacked += String(UnicodeScalar(22));
            break;
        case "QUAcKquack":
            deQuacked += String(UnicodeScalar(23));
            break;
        case "quaCKquack":
            deQuacked += String(UnicodeScalar(24));
            break;
        case "QuaCKquack":
            deQuacked += String(UnicodeScalar(25));
            break;
        case "qUaCKquack":
            deQuacked += String(UnicodeScalar(26));
            break;
        case "QUaCKquack":
            deQuacked += String(UnicodeScalar(27));
            break;
        case "quACKquack":
            deQuacked += String(UnicodeScalar(28));
            break;
        case "QuACKquack":
            deQuacked += String(UnicodeScalar(29));
            break;
        case "qUACKquack":
            deQuacked += String(UnicodeScalar(30));
            break;
        case "QUACKquack":
            deQuacked += String(UnicodeScalar(31));
            break;
        case "quackQuack":
            deQuacked += String(UnicodeScalar(32));
            break;
        case "QuackQuack":
            deQuacked += String(UnicodeScalar(33));
            break;
        case "qUackQuack":
            deQuacked += String(UnicodeScalar(34));
            break;
        case "QUackQuack":
            deQuacked += String(UnicodeScalar(35));
            break;
        case "quAckQuack":
            deQuacked += String(UnicodeScalar(36));
            break;
        case "QuAckQuack":
            deQuacked += String(UnicodeScalar(37));
            break;
        case "qUAckQuack":
            deQuacked += String(UnicodeScalar(38));
            break;
        case "QUAckQuack":
            deQuacked += String(UnicodeScalar(39));
            break;
        case "quaCkQuack":
            deQuacked += String(UnicodeScalar(40));
            break;
        case "QuaCkQuack":
            deQuacked += String(UnicodeScalar(41));
            break;
        case "qUaCkQuack":
            deQuacked += String(UnicodeScalar(42));
            break;
        case "QUaCkQuack":
            deQuacked += String(UnicodeScalar(43));
            break;
        case "quACkQuack":
            deQuacked += String(UnicodeScalar(44));
            break;
        case "QuACkQuack":
            deQuacked += String(UnicodeScalar(45));
            break;
        case "qUACkQuack":
            deQuacked += String(UnicodeScalar(46));
            break;
        case "QUACkQuack":
            deQuacked += String(UnicodeScalar(47));
            break;
        case "quacKQuack":
            deQuacked += String(UnicodeScalar(48));
            break;
        case "QuacKQuack":
            deQuacked += String(UnicodeScalar(49));
            break;
        case "qUacKQuack":
            deQuacked += String(UnicodeScalar(50));
            break;
        case "QUacKQuack":
            deQuacked += String(UnicodeScalar(51));
            break;
        case "quAcKQuack":
            deQuacked += String(UnicodeScalar(52));
            break;
        case "QuAcKQuack":
            deQuacked += String(UnicodeScalar(53));
            break;
        case "qUAcKQuack":
            deQuacked += String(UnicodeScalar(54));
            break;
        case "QUAcKQuack":
            deQuacked += String(UnicodeScalar(55));
            break;
        case "quaCKQuack":
            deQuacked += String(UnicodeScalar(56));
            break;
        case "QuaCKQuack":
            deQuacked += String(UnicodeScalar(57));
            break;
        case "qUaCKQuack":
            deQuacked += String(UnicodeScalar(58));
            break;
        case "QUaCKQuack":
            deQuacked += String(UnicodeScalar(59));
            break;
        case "quACKQuack":
            deQuacked += String(UnicodeScalar(60));
            break;
        case "QuACKQuack":
            deQuacked += String(UnicodeScalar(61));
            break;
        case "qUACKQuack":
            deQuacked += String(UnicodeScalar(62));
            break;
        case "QUACKQuack":
            deQuacked += String(UnicodeScalar(63));
            break;
        case "quackqUack":
            deQuacked += String(UnicodeScalar(64));
            break;
        case "QuackqUack":
